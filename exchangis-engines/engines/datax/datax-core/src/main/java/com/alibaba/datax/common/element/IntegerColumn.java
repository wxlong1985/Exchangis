...
public class IntegerColumn extends Column {
    ...
    /**
     * 从整形字符串表示转为IntegerColumn，支持Java科学计数法
     * <p>
     * NOTE: <br>
    ...
    public IntegerColumn(final String data) {
        ...
        try {
            ...
            throw DataXException.asDataXException(
                    ...
                    String.format("String[%s]不能转为Integer .", data));
        }
    }

    public IntegerColumn(Long data) {
        this(null == data ? (Integer) null : data.intValue());
    }
    ...
    private IntegerColumn(Integer data, int byteSize) {
        super(data, Type.INT, byteSize);
    }
    ...
    public byte[] asBytes() {
        throw DataXException.asDataXException(
                CommonErrorCode.CONVERT_NOT_SUPPORT, "Integer类型不能转为Bytes .");
    }
